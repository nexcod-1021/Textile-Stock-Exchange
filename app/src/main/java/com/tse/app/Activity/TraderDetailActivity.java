...
public class TraderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(TraderDetailActivity.this);
        findViewBy_Id();
        intent = getIntent();
   ...
   private class offer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            pg = new ProgressDialog(TraderDetailActivity.this);
        ...
        protected Void doInBackground(final Void... email) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.BaseUrl + Config.insert_offer,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (j.getString("STATUS").equalsIgnoreCase("true")) {
                                    Toast.makeText(TraderDetailActivity.this, "Offer is inserted", Toast.LENGTH_SHORT).show();
                ...
                protected Map<String, String> getParams() {
                    ...
                    map.put("userid", "TSET00044");
                    map.put("ordercode", "TSEO00001");
    ...
    private class offer_data extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected void onPreExecute() {
            pg1 = new ProgressDialog(TraderDetailActivity.this);
