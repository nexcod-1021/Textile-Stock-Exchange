 ...
 */
public class TradeSellerFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_trade_seller, container, false);
        RecyclerViewDeatailItem = view.findViewById(R.id.RvTraderSellerDeatailItem);
        linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        new TraderSellerDetail_Item().execute();
        return view;
    }
    private class TraderSellerDetail_Item extends AsyncTask<String, Void, String> {
        @Override
